  ...
  const handleCollectRewards = async () => {
    ...
    try {
      ...
      if (json.success) {
        ...
        setToast({
          id: Date.now(),
          message: json.message || "No rewards available.",
          type: "error",
        });
      }
    } catch {
    ...
    <>
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-20 bg-black/40 backdrop-blur-sm">
        <motion.div
          ...
          className="relative max-w-5xl w-full bg-black/70 border border-white/20 shadow-2xl p-8 md:p-12 flex flex-col gap-8"
        >
          ...
          <div className="text-center space-y-6">
            ...
            <p className="font-sans text-gray-400 text-sm md:text-base">
              To receive rewards, you must first link your accounts! Sign in
              with your Steam and Twitch accounts to continue your adventure and
              don’t miss out on exclusive rewards. If your accounts are linked
              to another profile, you can unlink them by signing in first.
            </p>
          </div>
