...
import STEAM_LOGO from "../../assets/images/steam-logo.png";
import PLAY_BG from "../../assets/images/play-bg.png";
import PLAY_FIRE from "../../assets/images/play-fire.png";
import PLAY_SHADOW from "../../assets/images/play-shadow.png";
      ...
      <div className="relative z-10 flex flex-col items-center justify-between h-full text-center text-white px-4 md:px-16 max-w-5xl mx-auto py-12">
        ...
        <div className="flex flex-col items-center justify-end pb-8">
          ...
          <motion.a
            ...
            className="mt-2 border border-[#c9a858]/60 rounded-xs px-6 py-2 backdrop-blur-sm hover:bg-black/60 transition inline-block"
      ...
      <AnimatePresence>
        {showTrailer && (
          ...
          >
            ...
            text-[#c9a858] border border-[#c9a858]/60 rounded-xs w-10 h-10 
          ...
          "
              ...
              <iframe
                ...
                allowFullScreen
                className="rounded-xs shadow-2xl"
              ></iframe>
            </motion.div>
          </motion.div>
        )}
